...
const qsa = selector => document.querySelectorAll(selector); //ADD GALLERY ITEMS


const galleryBox = qs('.gallery');
console.log(galleryBox);

const images = _galleryItems.galleryItems.map(item => `<a class = "gallery__item" href="${item.original}">
            <img class="gallery__image" src="${item.preview}"  alt="${item.description}" title="${item.description}"/> 
            </a>`).join('');

galleryBox.insertAdjacentHTML('afterbegin', images);
console.log(images); //ADDITIONAL OPTIONS
